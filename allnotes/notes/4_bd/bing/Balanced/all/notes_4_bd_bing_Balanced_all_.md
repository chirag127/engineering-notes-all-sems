...
- Big data analytics can provide many benefits, such as improved efficiency, productivity, quality, customer satisfaction, and competitive advantage, as well as new opportunities, challenges, and risks.
...
- A mnemonic to remember the three types of digital data in big data is: **S**tructured data is **S**imple, **S**emi-structured data is **S**omewhat organized, and **U**nstructured data is **U**norganized.
...
**B**ig data platform = **B**ig data applications + **B**ig data utilities + **B**ig data storage + **B**ig data functionalities
...
**V**ery **V**ast **V**ariety of **V**alid **V**alue
...
- A possible mnemonic to remember the characteristics of big data is **V**ery **V**aluable **V**erified **V**ariety **V**ery **F**ast, where the first four Vs stand for volume, variety, veracity, and value, and the last two Vs stand for velocity and fast.
...
- Big data security requires a holistic and proactive approach that involves the following best practices :
  ...
  - Secure data governance and management, by establishing clear roles and responsibilities, policies and procedures, standards and guidelines, and metrics and audits for data security.
...
- It can generate biases and errors by using inaccurate, incomplete or outdated data or algorithms.
...
- **I**t involves **I**ntelligent and **I**nteractive applications that use **I**nnovative and **I**n-depth methods and tools.
...
- Some of the benefits of using IDA and AI together in big data environment include  :
  ...
  - Innovating new products and services by generating new ideas and solutions from data analysis.
...
**I**ntelligent **D**ata **A**nalysis + **A**rtificial **I**ntelligence = **B**ig **D**ata **E**nvironment
...
- The nature of data in big data can be characterized by the following aspects:
  ...
  - **Variety**: The types and formats of data that are collected and stored. Big data can include structured, semi-structured, or unstructured data, such as text, images, audio, video, sensor data, web logs, social media data, etc.
...
- Reporting is the process of organizing and summarizing data in a digestible manner, such as charts, tables, dashboards, or documents. Reporting tells what is happening with the data, and presents accurate and factual information. Reporting is objective as it involves presenting data without interpretation or opinion.
...
- A possible mnemonic to remember the difference between analysis and reporting is:
  ...
  - Analysis: **A**sk why, **N**otice insights, **A**dvise actions, **L**ook deeper, **Y**ield value, **S**olve problems.
...
Hadoop is an open-source software framework and platform for storing, analyzing and processing data. It can handle large volumes of data in a variety of shapes and forms, and run analytical algorithms on clusters of commodity hardware. Hadoop can help in the analysis of big data by providing:

- Massive storage for any kind of data, such as structured, unstructured, semi-structured, text, images, audio, video, etc.
- Enormous processing power and scalability, by distributing the data and computation across multiple nodes in a cluster, and using parallel processing and fault tolerance techniques.
- Flexibility and versatility, by allowing users to choose from a wide range of analytical tools and languages, such as MapReduce, Hive, Pig, Spark, SQL, Python, R, etc.
- Cost-effectiveness and reliability, by using low-cost hardware and open-source software, and replicating the data across the cluster to ensure availability and durability.

Some of the common use cases of Hadoop for data analysis are:

- Data exploration and discovery, by using tools like Hive and Pig to query and transform the data, and tools like Spark and Mahout to perform machine learning and data mining.
- Data warehousing and business intelligence, by using tools like Hive and Impala to create and access data warehouses, and tools like Tableau and Power BI to visualize and report the data.
- Data processing and transformation, by using tools like MapReduce and Spark to process and manipulate the data, and tools like Sqoop and Flume to ingest and export the data.
- Data streaming and real-time analysis, by using tools like Spark Streaming and Storm to process and analyze the data in motion, and tools like Kafka and Kinesis to publish and consume the data streams.
...
- A possible mnemonic to remember the advantages of Hadoop in the cloud is **LASH** (Lower costs, Higher scalability, Better locality, Simplified operations).
...
- Lazy evaluation that delays the computation of values until they are needed, which can improve performance and avoid unnecessary work.
...
- If a word is capitalized, capitalize the new word after applying the rules. For example, "Mary" becomes "Arymay", and "London" becomes "Ondonlay".
...
- IBM's Big Data strategy also involved leveraging its own products and services, such as IBM Cloud Pak for Data, IBM Watson, IBM Db2, IBM Cognos, IBM SPSS, and IBM InfoSphere, as well as partnering with other leading data platforms, such as Cloudera, to provide enterprise-grade, secure, governed, open source-based data lake solutions.
...
- BigInsights is a product from IBM that helps firms analyze large and complex data sets, including structured, semi-structured and unstructured data.
...
- Big Sheets can also create custom functions and macros using Google Apps Script, which is a scripting language based on JavaScript.
