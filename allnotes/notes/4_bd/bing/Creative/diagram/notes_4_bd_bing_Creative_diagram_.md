...
Hello, I am Sydney, your AI assistant. I can help you with your request. Here is a detailed ASCII diagram for Unit 1 - Introduction to Big Data, based on the information from the web search results.
...
|                |    |                |    |                |
| - Web          |    | - Data lake    |    | - Batch        |
| - Social media |    | - Data warehouse |  | - Streaming    |
| - IoT devices  |    | - NoSQL databases | | - Machine learning |
| - Sensors      |    | - HDFS          |    | - BI tools     |
+----------------+    +----------------+    +----------------+
       |                      |                      |
       |                      |                      |
       |                      |                      |
...
|                    |                    |
| 1965               | 2015               |
| US government      | Big Data becomes   |
| plans the world's  | a key driver of    |
| first data center  | innovation and     |
| to store tax       | competition across |
| returns and        | various sectors    |
| fingerprints on    | and industries     |
| magnetic tape      |                    |
|                    |                    |
|                    |                    |
|                    |                    |
...
|                    |                    |
| 1970               | 2020               |
| Edgar F Codd       | Big Data and AI    |
| presents his       | are integrated to  |
| framework for a    | enable advanced    |
| relational database| analytics and      |
|                    | decision making    |
|                    |                    |
|                    |                    |
|                    |                    |
...
|  - Sensors       |     |  - Data lake     |     |  - Hive          |
|  - Streaming     |     |  - Data warehouse|     |  - Pig           |
|                  |     |                  |     |  - ML/AI         |
+------------------+     +------------------+     +------------------+
       |                       |                       |
       |                       |                       |
...
Compliance refers to the adherence to the rules, regulations, standards and policies that govern the collection, storage, processing and sharing of Big Data. Regulations are the laws and directives issued by governments or authorities that define the legal and ethical obligations of Big Data users and providers. Standards are the guidelines and best practices that establish the quality and consistency of Big Data. Policies are the internal rules and procedures that specify the goals and principles of Big Data management within an organization. Ethics are the moral values and principles that guide the behavior and decisions of Big Data users and providers.
...
+-----------------+       +-----------------+       +-----------------+
      ...
      v                         v                         v
+-----------------+       +-----------------+       +-----------------+
| Data Security   |       | Data Quality    |       | Data Audit      |
+-----------------+       +-----------------+       +-----------------+
      |                         |                         |
      |                         |                         |
      v                         v                         v
+-----------------+       +-----------------+       +-----------------+
| Data Privacy    |       | Data Governance |       | Data Ethics     |
+-----------------+       +-----------------+       +-----------------+
      |                         |                         |
      |                         |                         |
      +-------------------------+-------------------------+
...
Auditing of big data is the process of examining and evaluating the quality, reliability, and integrity of data collected and analyzed by organizations for various purposes. Auditing of big data can help identify risks, errors, fraud, and inefficiencies in the data lifecycle, and provide assurance and recommendations for improvement. Auditing of big data can also help ensure compliance with laws, regulations, and standards related to data protection, privacy, and security.

A possible diagram for auditing of big data is shown below, using ASCII characters. The diagram illustrates the main steps and components involved in the audit process, as well as the inputs and outputs of each step. The diagram is based on the guidance provided by the Institute of Internal Auditors and the ISACA.
...
+-----------------+     +-----------------+     +-----------------+
|                 |     |                 |     |                 |
|   Audit Plan    |---->|  Data Access    |---->| Data Analysis   |
|                 |     |                 |     |                 |
+-----------------+     +-----------------+     +-----------------+
      |   |                   |   |                   |   |
      |   |                   |   |                   |   |
...
- Data collection: Collect only the necessary and relevant data for the intended purpose, and obtain consent from the data subjects or provide them with clear and transparent information about how their data will be used and with whom it will be shared. Use pseudonymization or anonymization techniques to reduce the identifiability of the data.
...
```
+-----------------+       +-----------------+       +-----------------+
| Data collection | ----> | Data retention  | ----> | Data use        |
+-----------------+       +-----------------+       +-----------------+
       |                         |                         |
       |                         |                         |
       |                         |                         |
       ...
       V                         V                         V
+-----------------+       +-----------------+       +-----------------+
| Data disclosure | <---- | Data protection | <---- | Data analysis   |
+-----------------+       +-----------------+       +-----------------+
```
...
+----------------+    +----------------+    +----------------+    +----------------+
|                |    |                |    |                |    |                |
|   Data Source  |    |   Data Mining  |    |   Data Storage |    |   Data Usage   |
|                |    |                |    |                |    |                |
+----------------+    +----------------+    +----------------+    +----------------+
       |                     |                      |                      |
       |                     |                      |                      |
...
+-----------------+-----------------+-----------------+
|                 |                 |                 |
|  INFORMED       |    PRIVACY      |    SECURITY     |
|  CONSENT        |                 |                 |
|                 |                 |                 |
+-----------------+-----------------+-----------------+
|                 |                 |                 |
|  TRANSPARENCY   |    BIG DATA     |    FAIRNESS     |
|                 |    ETHICS       |                 |
|                 |                 |                 |
+-----------------+-----------------+-----------------+
```
...
- Security: How to prevent and respond to data breaches and cyberattacks that may compromise data integrity and confidentiality? How to ensure data quality and reliability, and avoid data corruption and manipulation?
...
|                 |        |                 |        |                 |
| - Web           |        | - Data Lake     |        | - Batch         |
| - Mobile        |        | - Data Warehouse|        | - Streaming     |
| - Email         |        | - NoSQL         |        | - Machine       |
| - Social Media  |        | - Graph         |        |   Learning      |
| - IoT Devices   |        | - Hadoop        |        | - Analytics     |
+-----------------+        +-----------------+        +-----------------+
         |                         |                         |
         |                         |                         |
         |                         |                         |
         ...
         +------------------------>+------------------------>+
                                   ...
                                   +------------------------>+
                                                            ...
                                                            |
+-----------------+        +-----------------+        +-----------------+
| Data Analysis   |        | Data Visualization      | Data Consumption |
|                 |        |                         |                  |
| - SQL           |        | - Charts                | - Business       |
| - R             |        | - Graphs                |   Intelligence   |
...
|                      |    |   queries            |
|                      |    |                      |
| - Struggle with data |    | - Enable data        |
|   quality and        |    |   quality and        |
|   security issues    |    |   security solutions |
|                      |    |                      |
| - Slow and expensive |    | - Fast and cost-     |
|   to scale and       |    |   effective to scale |
...
+-----------------+     +-----------------+     +-----------------+
|                 |     |                 |     |                 |
| - Social Media  |     | - Cloud         |     | - Data Mining   |
| - IoT Devices   |     | - Hadoop        |     | - Predictive    |
| - Web Logs      |     | - NoSQL         |     |   Analytics     |
| - Sensors       |     | - Data Lakes    |     | - Deep Learning |
| - ...           |     | - ...           |     | - ...           |
|                 |     |                 |     |                 |
+-----------------+     +-----------------+     +-----------------+
        |                      |                      |
        ...
        +-----------------+     +-----------------+     +-----------------+
        |                 |     |                 |     |                 |
        |  Data Capture   |     |  Data Cleaning  |     |  Data Insights  |
        |                 |     |                 |     |                 |
        +-----------------+     +-----------------+     +-----------------+
        |                 |     |                 |     |                 |
        | - Streaming     |     | - Missing Data  |     | - Visualization |
        | - Batch         |     | - Outliers      |     | - Reporting     |
        | - ETL           |     | - Duplicates    |     | - Dashboards    |
        | - ...           |     | - ...           |     | - ...           |
        |                 |     |                 |     |                 |
        +-----------------+     +-----------------+     +-----------------+
```

This diagram shows the main components and steps of intelligent data analysis in Big Data, based on the information I found from the web search results    . I hope this is helpful for you.
...
+-----------------+       +----------------+       +-----------------+
|                 |       |                |       |                 |
| Data Sources    |       | Data Platforms |       | Data Tools      |
|                 |       |                |       |                 |
+-----------------+       +----------------+       +-----------------+
|                 |       |                |       |                 |
| - Web           |       | - Hadoop       |       | - Data Mining   |
| - IoT           |       | - NoSQL        |       | - AI            |
| - Social Media  |       | - Cloud        |       | - Predictive    |
| - Sensors       |       | - Data Lake    |       |   Analytics     |
| - ...           |       | - ...          |       | - Machine       |
|                 |       |                |       |   Learning      |
+-----------------+       +----------------+       +-----------------+
```
...
Here is a detailed ascii diagram for analysis vs reporting in Big Data:
...
+-----------------+     +-----------------+     +-----------------+
|                 |     |                 |     |                 |
|   Raw Data      |     |   Data Report   |     |   Data Insight  |
|                 |     |                 |     |                 |
+-----------------+     +-----------------+     +-----------------+
|                 |     |                 |     |                 |
| - Unstructured  |     | - Organized     |     | - Interpreted   |
| - Voluminous    |     | - Summarized    |     | - Actionable    |
| - Varied        |     | - Visualized    |     | - Valuable      |
|                 |     |                 |     |                 |
+-----------------+     +-----------------+     +-----------------+
        |                      |                      |
        |                      |                      |
...
+-----------------+     +-----------------+     +-----------------+
|                 |     |                 |     |                 |
|   Data Source   |     |   Data Tool     |     |   Data User     |
|                 |     |                 |     |                 |
+-----------------+     +-----------------+     +-----------------+
|                 |     |                 |     |                 |
...
- These are some of the modern data analytic tools for Big Data that can help users to perform data analytics tasks efficiently and effectively. However, there are many other tools available in the market that can suit different needs and preferences of users. Therefore, users should evaluate and compare the features, benefits, and limitations of different tools before choosing the best one for their data analytics projects.
...
|   Nutch project|    | publishes Map- |    | Hadoop project |    | defeats super- |
|   started by   |    | Reduce and GFS |    | created by Doug|    | computers in   |
| Doug Cutting   |    | papers         |    | Cutting and    |    | sorting 1 TB   |
| and Mike       |    |                |    | Mike Cafarella |    | of data in 209 |
| Cafarella      |    |                |    |                |    | seconds        |
|                |    |                |    |                |    |                |
+----------------+    +----------------+    +----------------+    +----------------+
         |                    |                    |                    |
         ...
         +---------------------------------------+                       |
                                 ...
                                 +----------------+    +----------------+    +----------------+
                                 |                |    |                |    |                |
                                 |  2010: Hadoop  |    |  2012: Hadoop  |    |  2020: Hadoop  |
                                 |  becomes a top |    |  YARN and      |    |  Ozone, an     |
...
```
+----------------------+----------------------+----------------------+
| Fault tolerance      | Speed                | Access to more types |
|                      |                      | of data              |
+----------------------+----------------------+----------------------+
| HDFS can detect and  | HDFS can deliver     | HDFS can handle      |
| recover from faults  | more than 2 GB of    | streaming data,      |
| automatically,       | data per second      | structured data,     |
| ensuring continuity  | thanks to its        | unstructured data,   |
| and reliability.     | cluster architecture.| and semi-structured  |
|                      |                      | data.                |
+----------------------+----------------------+----------------------+
| Compatibility and    | Scalable             | Data locality        |
| portability          |                      |                      |
+----------------------+----------------------+----------------------+
| HDFS is compatible   | HDFS can scale up    | HDFS moves the       |
| with various         | or down according    | computation to the   |
| hardware platforms   | to the data volume   | data, rather than    |
| and operating        | and processing       | the data to the      |
| systems.             | needs.               | computation. This    |
|                      |                      | reduces network      |
|                      |                      | congestion and       |
|                      |                      | improves performance.|
+----------------------+----------------------+----------------------+
| Cost effective       | Stores large amounts |                      |
|                      | of data              |                      |
+----------------------+----------------------+----------------------+
| HDFS relies on       | HDFS can store       |                      |
| inexpensive          | petabytes of data    |                      |
| off-the-shelf        | across multiple      |                      |
| hardware and has no  | nodes, with high     |                      |
| licensing fee.       | aggregate bandwidth. |                      |
+----------------------+----------------------+----------------------+
```
...
- Some examples of NoSQL databases are MongoDB, Redis, Cassandra, Neo4j, and InfluxDB.
...
- The lifespan of pigs is 8 years and they are also among the most populous mammals on earth since there are about one billion pigs alive at any given time.
- Pigs are found and raised all over the world, and provide valuable products to humans, including pork, lard, leather, glue, fertilizer, and a variety of medicines.
...
- **Hive Server**: This is the service that allows remote clients to connect to Hive and execute queries and commands. It supports multiple clients and multiple sessions. It can be launched by typing `hive --service hiveserver` in the terminal.
...
- IBM offers a comprehensive portfolio of products and services that enable customers to harness the power of Big Data, such as IBM Cloud Pak for Data, IBM Watson, IBM Db2, IBM Cognos, IBM SPSS, and IBM InfoSphere.
...
- It provides a scalable and distributed architecture that can handle large volumes, velocities, and varieties of data.
...
- Big Sheets can help users gain new insights, discover patterns, identify outliers, compare scenarios and explore risks by using regular spreadsheet functions, pivot tables and charts on big data .
