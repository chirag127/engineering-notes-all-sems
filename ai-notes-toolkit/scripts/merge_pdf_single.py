...
def merge_pdfs(parent_dir,out_full_path):
    ...
    the output file is the name of the directory + _all_in_one.pdf
    """
...
def main():
    ...
    for parent_dir in folders:
        ...
        old_out_full_path = os.path.join(parent_dir, os.path.basename(parent_dir) + "_all_in_one.pdf")

        new_out_full_path = os.path.join(parent_dir,parent_dir.replace("/","_") + "_all_in_one.pdf")
