...
- Sampling distributions describe the behavior of sample statistics, such as the mean and the standard deviation, as random variables that depend on the sample size and the population parameters.
...
- These techniques are useful for exploring and testing various hypotheses about the data, and for making predictions and inferences based on the data.