...
- The product of the two regression coefficients is equal to the coefficient of correlation squared: b<sub>yx</sub> * b<sub>xy</sub> = r<sup>2</sup>. This shows the proportion of variation in one variable that is explained by the variation in the other variable.
