...
- In this unit, we will learn the basic concepts and notation of set theory, such as:
  ...
  - How to compare sets using the concepts of subset, superset, equality, and cardinality, and how to use them to classify sets into different types, such as finite, infinite, countable, and uncountable.
  - How to construct new sets from existing ones using the concepts of power set, Cartesian product, and function, and how to use them to model relations and mappings between sets.
- By the end of this unit, you should be able to:
  ...
  - Compare sets using the concepts of subset, superset, equality, and cardinality, and classify sets into different types.
  - Construct new sets from existing ones using the concepts of power set, Cartesian product, and function, and model relations and mappings between sets.