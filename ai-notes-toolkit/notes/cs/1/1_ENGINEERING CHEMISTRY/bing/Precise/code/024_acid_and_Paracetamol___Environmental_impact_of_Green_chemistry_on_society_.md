...
- Green chemicals either degrade to innocuous products or are recovered for further use. Plants and animals suffer less harm from toxic chemicals in the environment. Lower potential for global warming, ozone depletion, and smog formation. Less chemical disruption of ecosystems.
- Scientists and chemists can significantly minimize the risk to environment and health of human by the help of all the valuable ideology of green chemistry. The three main developments in green chemistry include use of super critical carbon dioxide water as green solvent, aqueous hydrogen peroxide as an oxidizing agent and use of hydrogen in asymmetric synthesis.
