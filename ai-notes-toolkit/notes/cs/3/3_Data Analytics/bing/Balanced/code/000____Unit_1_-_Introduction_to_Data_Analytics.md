...
- Data analytics can be classified into four types, depending on the level of complexity and the purpose of the analysis:
  ...
  - Prescriptive analytics: recommends what actions should be taken in the future using optimization and simulation.
- Data analytics can be performed using various tools and techniques, such as spreadsheets, databases, programming languages, statistical software, data visualization, and cloud computing.
