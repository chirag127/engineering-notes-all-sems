...
- DDL commands are normally executed by database administrators or developers, who have the permission to create and modify the database schema. DDL commands are not used by general users, who should access the database via an application.