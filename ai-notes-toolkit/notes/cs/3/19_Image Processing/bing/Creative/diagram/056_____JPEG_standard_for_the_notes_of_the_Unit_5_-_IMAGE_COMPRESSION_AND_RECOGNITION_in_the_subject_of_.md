...
- JPEG compression has many different options and color space regulations, such as the level of compression, the quality factor, the subsampling ratio, the quantization matrix, the Huffman coding, etc .
