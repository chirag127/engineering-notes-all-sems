...
- The algorithm requires the user to provide the markers, which can be challenging or time-consuming for some images.
- The algorithm can produce over-segmentation or under-segmentation depending on the choice of markers and the image characteristics.