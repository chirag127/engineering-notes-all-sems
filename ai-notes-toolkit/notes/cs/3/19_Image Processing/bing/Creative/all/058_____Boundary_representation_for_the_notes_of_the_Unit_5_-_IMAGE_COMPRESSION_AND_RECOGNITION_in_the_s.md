...
- Boundary extraction can be done using various techniques, such as morphological operations, edge detection, contour tracing, etc .
- Boundary extraction can also be modeled using polynomial transforms, which mimic some properties of the human visual system.
- Boundary representation and extraction are essential for image compression and recognition, as they reduce the amount of data to be stored and transmitted, and facilitate the identification and classification of objects in the image .