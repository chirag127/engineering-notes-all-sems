# Unit 6 - Transport Layer: TCP Congestion Control
...
The following algorithms require custom fields to be added to the TCP packet structure: Explicit Control Protocol (XCP) – XCP packets carry a congestion header with a feedback field, indicating the increase. MaxNet – Uses a single header field, which carries the maximum congestion level of any .