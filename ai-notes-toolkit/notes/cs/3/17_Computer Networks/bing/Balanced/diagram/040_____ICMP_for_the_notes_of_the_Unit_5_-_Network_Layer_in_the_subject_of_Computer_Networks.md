...
- However, ICMP can also be used for malicious purposes, such as scanning, spoofing, or denial-of-service attacks.
- Therefore, network administrators may need to filter or limit ICMP traffic to protect their networks from potential threats.