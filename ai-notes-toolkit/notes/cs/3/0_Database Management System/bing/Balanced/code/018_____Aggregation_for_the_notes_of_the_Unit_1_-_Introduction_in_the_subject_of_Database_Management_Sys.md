...
- For example, a person entity can be aggregated with a car entity to form a new entity called owner, which represents the ownership relationship between the person and the car.
