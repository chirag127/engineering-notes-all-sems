...
- Sqoop can import data from external datastores into Hadoop Distributed File System (HDFS) or related systems like Hive and HBase.
- It can also export data from Hadoop to external datastores.
- Sqoop works with relational databases such as Teradata, Netezza, Oracle, MySQL, and Postgres, as well as enterprise data warehouses.
