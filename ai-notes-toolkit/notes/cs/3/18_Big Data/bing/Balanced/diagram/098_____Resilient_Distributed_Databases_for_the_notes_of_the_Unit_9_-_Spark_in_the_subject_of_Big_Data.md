...
- RDDs can be manipulated using either low-level APIs or high-level APIs.
  - Low-level APIs provide more control and flexibility over the data processing, such as RDD, PairRDD, DoubleRDD, etc.
  - High-level APIs provide more abstraction and convenience over the data processing, such as DataFrame, Dataset, SQL, etc.