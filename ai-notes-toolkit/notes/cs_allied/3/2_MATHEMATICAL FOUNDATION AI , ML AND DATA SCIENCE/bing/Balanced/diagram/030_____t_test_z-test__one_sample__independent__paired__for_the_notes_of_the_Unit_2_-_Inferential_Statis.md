...
- There are three main types of t-test:
  - One sample t-test: A statistical test that compares the mean of one group to a specified value. For example, testing whether the average height of students in a class is equal to 170 cm.
...
- There are two main types of z-test:
  - One sample z-test: A statistical test that compares the proportion of a group to a specified value. For example, testing whether the proportion of voters who support a candidate is equal to 50%.
  - Two sample z-test: A statistical test that compares the proportions of two independent groups. For example, testing whether the proportion of smokers who develop lung cancer is different from the proportion of non-smokers who develop lung cancer.