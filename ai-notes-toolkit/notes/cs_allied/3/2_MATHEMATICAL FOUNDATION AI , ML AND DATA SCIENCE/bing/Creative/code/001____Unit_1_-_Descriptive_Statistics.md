...
Descriptive statistics are often used to explore and summarize data before conducting inferential statistics, which are methods of drawing conclusions and making predictions based on data. Descriptive statistics can help us identify potential relationships, outliers, and sources of variation in the data, which can inform our choice of inferential methods and hypotheses. However, descriptive statistics cannot prove causation or generalization beyond the data set.