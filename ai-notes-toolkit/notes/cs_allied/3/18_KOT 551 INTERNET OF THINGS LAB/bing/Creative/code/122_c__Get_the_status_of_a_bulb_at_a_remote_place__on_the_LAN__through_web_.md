...
- The steps to get the status of a bulb are as follows:
  ...
  - Write a program for the microcontroller that can read the state of the bulb (on or off) and send it as a response to a web request.
  - Upload the program to the microcontroller and run it.
  ...
  - The web browser will send a request to the microcontroller and display the response, which will be the status of the bulb (on or off).