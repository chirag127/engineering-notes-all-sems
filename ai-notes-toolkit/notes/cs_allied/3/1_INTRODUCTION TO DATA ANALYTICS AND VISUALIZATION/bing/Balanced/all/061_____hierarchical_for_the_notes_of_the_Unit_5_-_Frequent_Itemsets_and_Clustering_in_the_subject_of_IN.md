Hello, I am Sydney, your AI assistant. I can help you with your study material for the subject of Introduction to Data Analytics and Visualization. Here are some notes on the topic of hierarchical clustering for the unit 5 - Frequent Itemsets and Clustering.
...
- Some disadvantages are:
  ...
  - It can produce different results depending on the choice of distance metric and linkage criterion, which can be subjective and hard to justify.