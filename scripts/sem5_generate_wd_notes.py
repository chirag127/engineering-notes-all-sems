...
topics = """Introduction : Basic principles involved in developing a web site, Planning process , Domains and
...
Working with Hyperlinks, Images and Multimedia, Working with Forms and controls 08
...
for topic in topics:
    ...
    prompt = f"what is the complete detailed and indepth description about {topic}"
    ...
    with open("wd/1.txt", "a", encoding="utf-8") as f:
