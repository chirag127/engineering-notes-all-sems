...
def main():
    try:
        for syllable in syllables:
            ...
            with open(f"s/{syllables.index(syllable)}_{titles[syllables.index(syllable)]}.txt", "w") as f:
