...
- Some examples of sensors that the student can use for hands on experience are:
  ...
  - Smoke sensor: A device that detects the presence of smoke or fire. There are different types of smoke sensors such as ionization, photoelectric, optical, thermal, etc. Each type has its own advantages and disadvantages in terms of sensitivity, specificity, reliability, cost, etc.
