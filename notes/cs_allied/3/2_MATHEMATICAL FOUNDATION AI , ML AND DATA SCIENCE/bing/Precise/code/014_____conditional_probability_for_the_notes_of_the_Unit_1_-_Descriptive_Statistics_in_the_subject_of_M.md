...
4. Conditional probability can be used to calculate the probability of a sequence of events, such as the probability of drawing two red cards in a row from a deck of cards.
...
7. In the context of machine learning, conditional probability is used to calculate the probability of a class given a set of features, which is used in classification algorithms such as Naive Bayes.
