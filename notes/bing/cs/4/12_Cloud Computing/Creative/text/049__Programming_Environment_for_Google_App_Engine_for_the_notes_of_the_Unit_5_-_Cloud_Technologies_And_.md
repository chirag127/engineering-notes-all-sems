...
- To create an application for an app engine, you can use the SDKs and tools provided by Google for each language. You can develop and test an app locally using the SDK's deployment toolkit. Each language's SDK and runtime are unique.
- You can also use other Google Cloud services and APIs with your app engine application, such as Cloud Storage, Cloud Datastore, Cloud SQL, Cloud Pub/Sub, Cloud Vision, and more.