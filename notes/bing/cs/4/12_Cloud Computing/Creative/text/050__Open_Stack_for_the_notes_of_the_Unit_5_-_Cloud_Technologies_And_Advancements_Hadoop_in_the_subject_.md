...
- Open Stack is developed by the community and has a modular architecture that allows users to choose the components and features they need for their cloud environment.
- Some of the core components of Open Stack are:
  ...
  - Neutron: the networking service that provides connectivity and network management for instances and other resources.
  ...
  - Horizon: the dashboard service that provides a web-based user interface for managing Open Stack resources.
  - Heat: the orchestration service that allows users to define and deploy cloud applications using templates.
  ...
  - Other components include Sahara, Trove, Zaqar, Manila, Designate, Barbican, Magnum, and more.