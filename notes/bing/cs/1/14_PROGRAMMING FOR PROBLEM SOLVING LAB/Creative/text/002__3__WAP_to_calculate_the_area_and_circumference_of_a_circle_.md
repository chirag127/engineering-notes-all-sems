...
- To write a program (WAP) to calculate the area and circumference of a circle, we need to follow these steps:
...
# Declare two variables to store the area and circumference of the circle
A = 0
C = 0

# Use the formulas to calculate the area and circumference of the circle
A = 3.14 * r * r
C = 2 * 3.14 * r

# Display the values of the area and circumference of the circle
