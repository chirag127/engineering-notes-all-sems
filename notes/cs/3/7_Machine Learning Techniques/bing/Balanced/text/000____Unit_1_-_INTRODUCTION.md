...
- AI has many applications and benefits for various fields and domains, such as medicine, education, entertainment, business, and security.
  ...
  - AI can help teach and learn subjects, assess students' progress, and personalize learning paths, such as Knewton, Coursera, and Duolingo.
  - AI can help create and enjoy games, movies, music, and art, such as AlphaGo, DeepMind's WaveNet, and Google's DeepDream.
  - AI can help optimize business processes, analyze data, and make decisions, such as Amazon's recommendation system, Netflix's content delivery network, and Uber's surge pricing.
  - AI can help protect and defend against cyberattacks, fraud, and terrorism, such as DARPA's Cyber Grand Challenge, Mastercard's Decision Intelligence, and Facebook's DeepText.
- AI also poses many challenges and risks for society and humanity, such as ethical, social, legal, and existential issues.
  ...
  - AI can have legal implications for the regulation, governance, and liability of AI systems and their actions, such as laws, policies, standards, and audits.
  - AI can have existential threats to the survival and well-being of humans and other life forms, such as superintelligence, rogue AI, and artificial conflict.