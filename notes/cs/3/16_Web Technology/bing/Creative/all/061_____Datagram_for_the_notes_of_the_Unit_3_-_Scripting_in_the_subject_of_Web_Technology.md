...
- A datagram can be lost, corrupted, duplicated, or delivered out of order due to network congestion, errors, or failures.
- A datagram is suitable for applications that can tolerate some degree of unreliability, such as voice or video streaming, or that require low latency, such as real-time gaming.
