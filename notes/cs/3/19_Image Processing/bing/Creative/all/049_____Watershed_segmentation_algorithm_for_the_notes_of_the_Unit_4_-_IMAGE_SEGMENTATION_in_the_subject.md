...
- The algorithm starts from user-defined markers, which are pixels that belong to a certain object or the background .
...
- The algorithm can be used for various applications, such as counting the objects or for further analysis of the separated objects .