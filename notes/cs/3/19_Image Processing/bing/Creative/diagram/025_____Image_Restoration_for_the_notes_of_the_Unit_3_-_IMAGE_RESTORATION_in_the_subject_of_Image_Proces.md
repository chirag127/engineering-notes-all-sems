...
- Spatial domain methods operate directly on the pixels of the image and apply some mathematical operations to modify the pixel values.
- Frequency domain methods transform the image into its frequency components and apply some filters to enhance or suppress certain frequencies.
- Some common image restoration techniques are: inverse filtering, Wiener filtering, Richardson-Lucy algorithm, blind deconvolution, total variation regularization, etc.