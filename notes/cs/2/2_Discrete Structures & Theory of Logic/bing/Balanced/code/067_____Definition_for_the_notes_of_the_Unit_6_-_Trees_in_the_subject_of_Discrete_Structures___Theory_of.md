...
- A **sibling** is a node that has the same parent as another node .
...
- A **rooted tree** is a special type of directed tree that has a designated root and the direction of every edge is away from the root.