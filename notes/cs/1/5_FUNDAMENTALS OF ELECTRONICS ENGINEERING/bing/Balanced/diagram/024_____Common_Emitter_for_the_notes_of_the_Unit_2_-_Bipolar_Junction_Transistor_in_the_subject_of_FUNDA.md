...
- The CE amplifier can be analyzed using the hybrid-pi model, which is a small-signal model that relates the input and output voltages and currents of the amplifier.

The following diagram shows the basic circuit of a CE amplifier:
