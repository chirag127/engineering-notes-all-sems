...
- The key characteristics of a common collector configuration are:
  ...
  - Non-inverting voltage gain of approximately one .
- The common collector configuration is typically used as a voltage buffer or a level shifter .
- The input circuit is connected between emitter and base and the output is taken from the collector and emitter.
- The basic NPN common collector circuit (neglecting biasing details) is shown below:
