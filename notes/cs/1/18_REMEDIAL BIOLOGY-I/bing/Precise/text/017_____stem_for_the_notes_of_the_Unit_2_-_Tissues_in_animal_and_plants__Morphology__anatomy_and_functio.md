...
The stem is an important part of the plant that serves several functions. Here are some key points about the stem in the context of Unit 2 - Tissues in animal and plants, Morphology, anatomy and functions of different parts of plants: Root, stem, leaf, inflorescence, flower, fruit and seed, in the subject of REMEDIAL BIOLOGY-I KCS:
...
6. The stem can be modified to perform different functions, such as climbing, protection, and storage.
7. The anatomy of the stem includes different tissues, such as the epidermis, cortex, vascular tissue, and pith.
8. The morphology of the stem can vary greatly between different plants, with some having a single, unbranched stem, while others have branched stems.
