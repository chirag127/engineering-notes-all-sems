...
- The chemical structure of polymers affects their properties in several ways, such as:
  ...
  - Side groups: The presence of different functional groups or atoms attached to the polymer backbone affects the polarity, solubility, and compatibility of the polymer. For example, polar side groups increase the intermolecular forces and the solubility of the polymer in polar solvents, while non-polar side groups decrease them.

- Here is a diagram that illustrates some of the effects of chemical structure on polymer properties:

```
   Chain length      Branching      Cross-linking      Crystallinity      Side groups
   ↑                 ↓              ↑                  ↑                  ↑
   ↑                 ↓              ↑                  ↑                  ↑
   ↑                 ↓              ↑                  ↑                  ↑
   ↑                 ↓              ↑                  ↑                  ↑
